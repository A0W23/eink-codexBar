...
CODEX_HOME="$codex_data" codex plugin marketplace add "$stage" --json >/dev/null
CODEX_HOME="$codex_data" codex plugin add codex-zectrix-dashboard@codex-zectrix-dashboard --json >/dev/null
CODEX_HOME="$codex_data" codex plugin list --json | grep -q 'codex-zectrix-dashboard'
